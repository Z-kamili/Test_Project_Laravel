                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex justify-content-between">
                                <a type="button" href="{{route('Deals.index')}}" class="btn btn-primary" data-toggle="modal" data-target="#add">
                                    Add Deals
                                </a>
                            </div>
                        </div>
                                ...
                                <table class="table text-md-nowrap" id="example2">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endif
                                            <td>
                                                <a class="label bg-info" href="{{route('Edit',['deals' => $item])}}">Edit</a>
                                                <a class="label bg-info" href="{{route('Delete',['deals' => $item])}}">Delete</a>
                                            </td>
                                        </tr>
                                      @endforeach
                                    </tbody>
